    ...
    public void map(WritableComparable key, 
      ...
      while (numBytesToWrite > 0) {
        ...
        if (++itemCount % 20 == 0) {
          ...
          System.out.println ("wrote record " + itemCount + ". " + 
                  numBytesToWrite + " bytes left.");
          
//          System.out.println ("randomKey [" + randomKey + "] randomValue [" + 
//        		  randomValue + "]");
    ...
    public void configure(JobConf job) {
      //numBytesToWrite = job.getLong("test.randomwrite.bytes_per_map", 1*1024*1024*1024);
    	numBytesToWrite = job.getLong("test.randomwrite.bytes_per_map", 10*1024*1024);
